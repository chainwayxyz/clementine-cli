...
clementine-cli deposit generate-address --network testnet <RECOVERY_TAPROOT_ADDRESS> <CITREA_ADDRESS>

# Monitor deposits (online device)
clementine-cli deposit check-status <DEPOSIT_ADDRESS> # Mainnet
clementine-cli deposit check-status --network testnet <DEPOSIT_ADDRESS>
