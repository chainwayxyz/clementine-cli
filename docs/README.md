...
- **[Download & Verify](download-verify.md)** - Download pre-built binaries and verify signatures
...
- **[Advanced Usage](advanced.md)** - Advanced users only: signet/regtest config, API/RPC selection, hidden CLI commands
