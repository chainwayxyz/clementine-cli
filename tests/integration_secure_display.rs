...
use clementine_cli::secure_display::{display_mnemonic_securely, SecureMnemonicDisplay};
...
fn test_secure_mnemonic_display_integration() {
    ...
    match display_mnemonic_securely(secure_mnemonic) {
        ...
        Err(e) => {
            println!("⚠️  Secure display failed (this is expected in CI/non-interactive environments): {}", e);
        }
    }
...
fn test_mnemonic_word_formatting() {
    let test_mnemonic = "word1 word2 word3 word4 word5 word6 word7 word8 word9 word10 word11 word12";
