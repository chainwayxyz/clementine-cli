...
use clementine_cli::cli_network::{CliNetwork, NetworkParser, NETWORK_HELP};
...
enum WalletCommands {
    ...
    Create {
        #[arg(long, default_value_t = CliNetwork::Bitcoin, value_parser = NetworkParser, help = NETWORK_HELP)]
        network: CliNetwork,
